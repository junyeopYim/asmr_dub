...
FULL_REAL_QUALITY_PRESET = {
    ...
    "tts_candidate_pool_enabled": True,
    "tts_selected_audio_required": True,
    "tts_router_enabled": True,
    "tts_router_default_backends": ["gpt_sovits"],
    "tts_router_qwen_parallel_enabled": True,
    "tts_router_micro_segment_max_sec": 2.2,
    "tts_router_qwen_for_micro_segments": True,
    "tts_router_qwen_for_numeric_sequences": True,
    "tts_router_qwen_for_gsv_pronunciation_failures": True,
    "tts_router_qwen_for_gsv_duration_failures": True,
    "tts_router_qwen_for_auto_repair_qwen_action": True,
    "tts_selector_duration_tolerance": 0.25,
    "tts_selector_require_numeric_sequence_qc": True,
    "tts_selector_require_pronunciation_qc_for_numeric": True,
    "tts_selector_weight_duration_fit": 0.30,
    "tts_selector_weight_pronunciation": 0.25,
    "tts_selector_weight_ko_asr_backcheck": 0.20,
    "tts_selector_weight_style_match": 0.10,
    "tts_selector_weight_noise": 0.10,
    "tts_selector_weight_backend_prior": 0.05,
    "translate_ko_safety_retry_enabled": True,
    "translate_ko_safety_retry_max_attempts": 2,
    "translate_ko_safety_retry_modes": [
        "same_model_low_temp",
        "literal_only_no_expansion",
        "context_trimmed",
    ],
    "translate_ko_safety_block_policy": "quarantine_segment",
...
def regenerate(
    ...
    tts_backend: str = typer.Option(
        "gpt-sovits",
        "--tts-backend",
        help="gpt-sovits|qwen|auto|pool|candidate-pool|fish|cosyvoice|mock",
    ),
    gemma_backend: str = typer.Option("mock", "--gemma-backend", help="mock|hf|http|llama_cpp"),
    confirm_rights: bool = typer.Option(False, "--confirm-rights", help=RIGHTS_HELP),
    gsv_url: str | None = typer.Option(None, "--gsv-url"),
...
def auto_repair(
    ...
    tts_backend: str = typer.Option(
        "gpt-sovits",
        "--tts-backend",
        help="gpt-sovits|qwen|auto|pool|candidate-pool|mock",
    ),
